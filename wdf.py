...
def main():
    ...
    for i in range(0, group_num):
        ...
        for i in range(DeletedCount):
            if d[DeletedList[i]][1] != '':
                print(str(d[DeletedList[i]][0],encoding='utf-8'),str(d[DeletedList[i]][1],encoding='utf-8'))
            else:
                print(str(d[DeletedList[i]][0]))
    ...
    for r in result:
        if d[r][1] != '':
            resultNames.append(str(d[r][0],encoding='utf-8')+str(d[r][1],encoding='utf-8'))
        else:
